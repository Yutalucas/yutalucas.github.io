...
class ThreeJSContainer {
    ...
    createScene = () => {
        ...
        // スフィアの作成と追加
        const sphereGeometry = new three__WEBPACK_IMPORTED_MODULE_4__.SphereGeometry(0.5, 16, 16);
